...
var guestInvited = ['jackie', 'aliya', 'salman', 'ali', 'imran', 'alexa'];
...
while (guestInvited.length > 2) {
    var removeGuests = guestInvited.pop();
    console.log("Dear ".concat(removeGuests, ", you are not invited to dinner."));
}
// part 3 - (still invited message to 2 guests that are remaining.)
guestInvited.map(function (items) { return console.log("\n".concat(items, ", you are still invited for a dinner.")); });
